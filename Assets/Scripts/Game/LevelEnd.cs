...
public class LevelEnd : MonoBehaviour
{
    ...
    void Start()
    {
        camera = GameObject.FindGameObjectWithTag("SecondCamera").gameObject;
    }
    ...
    private IEnumerator changeLevel()
    {
        ...
        camera.GetComponent<CameraController3D>().enabled = false;
        ...
        camera.GetComponent<CameraController3D>().enabled = true;
